...
VerificationReport verify_stationary(const ChannelConfig& cfg,
  ...
  // Gauss-law charge-closure consistency (legacy field name: maxwell_mismatch)
  ...
  // Dirichlet Maxwell relation for the system-side gate-perceived charge: dΩ/dVG = Q_gate.
